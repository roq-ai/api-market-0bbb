...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'API Update.update': {
    roles: ['business-owner', 'api-developer', 'api-consumer', 'team-member', 'administrator'],
    key: 'API Developer',
    tenantPath: [],
    userPath: [],
  },
  'API Limit Reached.update': {
    roles: ['business-owner', 'api-developer', 'api-consumer', 'team-member', 'administrator'],
    key: 'API Consumer',
    tenantPath: [],
    userPath: [],
...
const tenantRoles: string[] = ['business-owner', 'api-developer', 'api-consumer', 'team-member', 'administrator'];
