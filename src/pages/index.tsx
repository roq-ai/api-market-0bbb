  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="API Market - Transforming the way Companies and Developers Discover and Utilize APIs for Unprecedented Growth and Innovation"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1623282033815-40b05d96c903?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxBUEl8ZW58MHx8fHwxNjk1NTM2ODQyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@douglasamarelo?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Douglas Lopes`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`API Market - Transforming the way Companies and Developers Discover and Utilize APIs for Unprecedented Growth and Innovation`}
            </Text>
            <Box
